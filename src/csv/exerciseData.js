...
export function parseExerciseData(raw) {
  ...
  // Determine repsUnit — if reps side was detected as time-based, propagate it
  const repsUnit = (repsSideUnit === 'sec' || repsSideUnit === 'time') ? repsSideUnit : 'reps';
...
// Re-export display utilities from their canonical location
export { secondsToMmss, mmssToSeconds, formatSet, groupSets } from '../utils/formatters';
